...
export function useOutletFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOutletFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.outlet.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOutletCount<T extends Prisma.outletCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.outletCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useOutletCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.outlet.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOutletFindManyWithCount<
  T extends Prisma.outletFindManyArgs,
  R extends { data: GetFindResult<Prisma.$outletPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.outletFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOutletFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.outlet.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOutletFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOutletFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.outlet.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
